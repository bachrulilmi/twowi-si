...
$this->title = 'Pembayaran Kandidat Baru';
?>
<!--  start page-heading -->
	<div id="page-heading">
	...
	<!--  start top-search -->
					<div id="top-search">
					<form class="form-inline" action="<?= Url::to(['kandidat/list-bayar']); ?>" method="post" >
				...
				<tr>
					...
					<th class="table-header-repeat line-left"><p>Tanggal Lahir</p></th>
					<th class="table-header-repeat line-left"><p>Jurusan</p></th>
					<th class="table-header-repeat line-left"><p>Posisi Jabatan</p></th>
				...
				<tr>
					...
					<td><?= $kan->tanggallahir ?></a></td>
					<td><?= $kan->jurusan ?></td>
					<td><?= $kan->jabatan ?></a></td>
					<td class="options-width">
					
					<a href="index.php?r=kandidat/disable&id=<?= $kan->id ?>" title="Non Aktif" class="icon-disable info-tooltip"></a>
					<a href="index.php?r=kandidat/bayar&id=<?= $kan->id ?>" title="Edit" class="icon-bayar info-tooltip"></a>
					</td>
				</tr>
				<?php endforeach; ?>
				</table>
