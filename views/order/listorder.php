						...
						<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
							...
							<tr>
								...
								<td class="options-width">
									...
									<a href="index.php?r=order/disable&id=<?= $or->id ?>" title="Non Aktif" class="icon-disable info-tooltip"></a>

									<a href="index.php?r=order/edit&id=<?= $or->id ?>" title="Edit Order" class="icon-view-edit info-tooltip"></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</table>
