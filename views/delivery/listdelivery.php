		...
		<td>
			...
			<div id="content-table-inner">
				...
				<div id="table-content">
					...
					<!--  start top-search -->
					<div id="top-search">
					<form class="form-inline" action="<?= Url::to(['delivery/list-deliv']); ?>" method="post" >
						...
						<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
							...
							<tr>
								...
								<td class="options-width">
									...
									<a href="index.php?r=delivery/pilih-kandidat&id=<?= $or->id ?>" title="Preparing" class="icon-view-edit info-tooltip"></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</table>
