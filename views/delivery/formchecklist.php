...
<!--  start page-heading -->
	...
	<?php $form = ActiveForm::begin([
		...
		<?= $form->field($model, 'ijazah')->fileInput()->label('Ijazah') ?>
		<?= $form->field($model, 'transkrip')->fileInput()->label('Transkrip Nilai') ?>
		<?= $form->field($model, 'kartukel')->fileInput()->label('Kartu Keluarga') ?>
		<?= $form->field($model, 'suratkuning')->fileInput()->label('Surat Kuning') ?>
		<?= $form->field($model, 'pengalamankerja')->fileInput()->label('Surat Pengalaman Kerja') ?>
