...
<!--  start page-heading -->
	...
	<?php $form = ActiveForm::begin([
		'action'=>Url::to(['mitra/update', 'id' =>$model->id ]),
        'id' => 'login-form',
        'layout' => 'horizontal',
        'fieldConfig' => [
		...
		<?= $form->field($model, 'namapictwi') ->label('Nama PIC TWI')?>
		<?= $form->field($model, 'emailpictwi') ->label('Email PIC TWI')?>
        ...
        <div class="form-group">
            <div class="col-lg-offset-1 col-lg-11">
                ...
                <button type="button" class="btn btn-warning" onclick="location.href='<?= Url::to(['mitra/contract', 'id' =>$model->id ]) ?>'">Manage Contract</button>
                <button type="button" class="btn btn-danger" onclick="location.href='<?= Url::to(['mitra/list' ]) ?>'">Batal</button>
